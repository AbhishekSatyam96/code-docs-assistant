...
export const EVAL_QUESTIONS: EvalQuestion[] = [
  ...
  {
    id: "buildFtsQuery",
    question: "Where is buildFtsQuery defined?",
    kind: "lexical",
    expectedFiles: ["lib/retrieval/fts-query.ts"],
  },
  {
    id: "fts-injection",
    question: "How is the user's question stopped from injecting FTS5 operators?",
    kind: "semantic",
    expectedFiles: ["lib/retrieval/fts-query.ts"],
  },
  {
  ...
  {
    id: "vec0",
    question: "How are embeddings stored and queried in SQLite?",
    kind: "semantic",
    expectedFiles: ["lib/db/index.ts", "lib/retrieval/index.ts"],
  },
  {
    id: "toVectorBlob",
    question: "What is toVectorBlob for?",
    kind: "lexical",
